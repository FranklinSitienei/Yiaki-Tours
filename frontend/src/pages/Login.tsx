...
const AuthPage = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gradient-to-r from-white via-green-300 to-nature-300 relative overflow-hidden">
      <div
        className={`flex w-4/5 max-w-5xl shadow-2xl rounded-lg overflow-hidden transform transition-all duration-700 ${
      ...
      >
        ...
        <div className="w-1/2 relative">
          ...
          />
          <div className="absolute bottom-10 left-10 bg-white bg-opacity-70 p-4 rounded-lg animate-slideUp">
        ...
        <div className="w-1/2 bg-white flex flex-col items-center justify-center py-10 px-8">
